<?php /*a:3:{s:50:"D:\php\smssend\application\admin\view\sms\log.html";i:1625501250;s:55:"D:\php\smssend\application\admin\view\layout\_meta.html";i:1625501250;s:57:"D:\php\smssend\application\admin\view\layout\_footer.html";i:1625501250;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    var app_model = new Vue({
        ...
        methods: {
            ...
            //上一页,下一页翻页
            pageClick: function(){
                initTable("<?php echo url('sms/log'); ?>",this.current,this.search);
            },
            ...
            btnDel: function (event, index) {
                ...
                admin_del("<?php echo url('sms/del_log'); ?>", id, index);
            },
            ...
            adminBathDel:function(){
                ...
                admin_del("<?php echo url('sms/del_log'); ?>", ids);
            },
    ...
    //初始化数据表格
    initTable("<?php echo url('sms/log'); ?>");
</script>
</body>
</html>