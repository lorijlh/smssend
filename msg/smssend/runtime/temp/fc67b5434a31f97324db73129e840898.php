<?php /*a:3:{s:55:"D:\php\smssend\application\admin\view\service\edit.html";i:1625501250;s:55:"D:\php\smssend\application\admin\view\layout\_meta.html";i:1625501250;s:57:"D:\php\smssend\application\admin\view\layout\_footer.html";i:1625501250;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="cl pd-20">
    <form class="form form-horizontal" id="form-admin">
        ...
        <?php endif; ?>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">服务商名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" v-model="model.name" placeholder="请输入服务商名称">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">短信服务商：</label>
            <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">短信account：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" v-model="model.account" placeholder="请输入短信account">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">短信key：</label>
            <div class="formControls col-xs-8 col-sm-9">
...
<script type="text/javascript">
    ...
    util.get("<?php echo url('service/edit'); ?>", {id:"<?php echo htmlentities($edit_id); ?>"},function (data) {
